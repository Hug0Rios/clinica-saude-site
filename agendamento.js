...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (breadcrumb) {
        setTimeout(() => {
            breadcrumb.classList.add('animate-in');
        }, 100);
    }

    // Animação do hero
    const hero = document.querySelector('.hero-agendamento');
    if (hero) {
        setTimeout(() => {
    ...
    // Animação da seção de agendamento
    const schedulingSection = document.querySelector('.scheduling-section');
    if (schedulingSection) {
        setTimeout(() => {
            schedulingSection.classList.add('animate-in');
        }, 500);
    }
    ...
    // Animação dos fieldsets do formulário
    ...
    // Animação dos botões do formulário
    ...
    // Animação da seção de informações úteis
    const infoSection = document.querySelector('.informacoes-uteis');
    if (infoSection) {
        setTimeout(() => {
    ...
    // Animação dos boxes de informação
